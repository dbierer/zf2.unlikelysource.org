...
$settings = array(
     ...
     */
    // see config/autoload/db.local.php
    ...
    // 2013-02-12 DB: Added registration key option
	/**
     * Require registration key to register
     *
     * Allows only users who enter the correct key to register through the website
     *
     * Accepted values: boolean true or false
     */
    'enable_registration_key' => true,
...
//            'zfcuser_zend_db_adapter' => (isset($settings['zend_db_adapter'])) ? $settings['zend_db_adapter']: 'Zend\Db\Adapter\Adapter',
        	// see config/autoload/db.local.php
            'zfcuser_zend_db_adapter' => 'general-adapter',
        ),
    ),
);
